...
import { AnimatedSection } from "@/components/shared/Animated/Animated";
      ...
      <AnimatedSection height={400}>
        <div className="surface-ground text-center pb-8">
          ...
          <div className="text-700 mb-6">
            ...
            Connect, созданного для максимального комфорта и эффективности в
            ваших тренировках.
          </div>
          <div className="grid">
            <div className="col-12 md:col-4 mb-4 px-5">
              ...
              <span className="text-700 line-height-3">
                ...
                вести активный образ жизни, сохранять интерес к занятиям спортом
                и продолжать тренироваться, несмотря на недостаток свободного
                времени.
              </span>
            </div>
            <div className="col-12 md:col-4 mb-4 px-5">
              ...
              <span className="text-700 line-height-3">
                Выбери дистанцию, пробеги её или пройди по улице, либо в
                закрытом помещении (например на беговой дорожке), в любое
                удобное для тебя время и получи уникальную медаль! Бери с собой
                членов семьи или друзей и финишируйте вместе!
              </span>
            </div>
            <div className="col-12 md:col-4 mb-4 px-5">
              <span
            ...
            <div className="col-12 md:col-4 mb-4 px-5">
              ...
              <span className="text-700 line-height-3">
                ...
                оставаться здоровым и активным, испытывать удовольствие от
                занятий и с каждым днём становиться лучшей версией себя!
              </span>
            </div>
            <div className="col-12 md:col-4 mb-4 px-5">
              <span
              ...
              <span className="text-700 line-height-3">
                ...
                как это бывает на традиционных забегах, но вы можете участвовать
                в своём собственном графике и со своим темпом.
              </span>
            </div>
            ...
            <div className="col-12 lg:col-3">
              ...
              <div className="p-3 h-full">
                ...
                >
                  ...
                  />
                  <div className="text-600">
                    Ride the roads with our cycling plans tailored for cyclists
                    of all levels.
                  </div>
                  <hr className="my-3 mx-0 border-top-1 border-bottom-none border-300" />
