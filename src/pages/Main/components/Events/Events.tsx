    ...
    <div className="surface-0 py-8">
      ...
      <div className="grid">
        <div className="col-12 lg:col-3">
          <div className="p-3 h-full border-1 border-primary surface-border border-round">
            ...
            <div className="text-600">
              Enjoy your runs with our tailored plans for runners of all levels.
            </div>
        ...
        <div className="col-12 lg:col-3">
          ...
          <div className="p-3 h-full border-1 border-primary surface-border border-round">
            ...
            />
            <div className="text-600">
              Ride the roads with our cycling plans tailored for cyclists of all
              levels.
            </div>
            <hr className="my-3 mx-0 border-top-1 border-bottom-none border-300" />
